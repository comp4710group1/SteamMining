...
#API Key
apiKey = "203D1B12FF0FE7CD49A5AA30BE98C453" # probably change this to your own api key before you start running
...
for i in range (1040000): #increment by 10000 before running
    next(f)
