...
#API Key
apiKey = "C4364E1FFD0AFF0CA0FD74ACBD3ADBFF" # probably change this to your own api key before you start running
...
for i in range (1510000): #increment by 10000 before running
    next(f)
